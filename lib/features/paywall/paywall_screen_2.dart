...
class _PurchaseViewState extends State<PurchaseView>
      ...
      builder: (_, __) => Transform.rotate(
        ...
        child: Transform.scale(
          ...
          child: Container(
            ...
            child: _HeroPlaceholder(color: _accent),
          ),
        ),
      ),
    );
  ...
  Widget _buildFeatures() {
    const features = [
      (icon: Icons.star_rounded, label: 'Unlimited scenario comparison'),
      (icon: Icons.star_rounded, label: 'Real-time local tax updates'),
      (icon: Icons.star_rounded, label: 'Ad-free experience'),
      (icon: Icons.lock_outline_rounded, label: 'Remove annoying paywalls'),
    ];
    return Column(
...
/// Replace with Image.asset('assets/purchaseview-hero.png').
